...
from    Models.tactis.gluon.metrics import compute_validation_metrics, SplitValidationTransform
...
class TACTiSEstimator(PyTorchEstimator):
    ...
    def __init__(
        ...
        print("model_parametersssssssssssssss  = ", model_parameters)
    ...
    def create_training_network(self, device: torch.device) -> nn.Module:
        ...
        """
        print(" create training netwrorkkkkkkkkkkkkkkkkkk")
    ...
    def create_instance_splitter(self, mode: str) -> Transformation:
        ...
        """
        print("create instance spliterrrrrrrrrrrrrrrrrrrrrrr")
    ...
    def create_transformation(self) -> Transformation:
        ...
        """
        print("createeeeee transformationnnnnnnnnnnnnnnn")
        return Chain(
            [
                AddObservedValuesIndicator(
                    target_field=FieldName.TARGET,
    ...
    def create_predictor(
        ...
        print("predictorrrrrrrrrrrrrrrrrrrrrrr")
        ...
        return PyTorchPredictor(
            ...
            # Removed the problematic freq parameter
            prediction_length=self.prediction_length,
            device=device,
        )
    ...
    def train_model(
        ...
        **kwargs,
        ...
        print("training moellllllllllllllllllllllll")
        ...
        return {"loss_history": loss_history, "predictor": predictor}
    def train(
        self,
        training_data: Dataset,
        validation_data: Optional[Dataset] = None,
    ...
    def validate_model(
        ...
        print("validateeeeeeeeeeeeeeeeeeeeeeeeeee")
        transformation = self.create_transformation()
